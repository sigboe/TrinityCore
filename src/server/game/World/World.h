...
enum WorldBoolConfigs : uint32
{
    ...
    CONFIG_ALWAYS_UPDATE_WAYPOINT_CREATURES,
    CONFIG_HIDE_GAMEOBJECT_SPARKLE,
...
enum WorldFloatConfigs : uint32
{
    ...
    CONFIG_RESPAWN_DYNAMIC_CREATURE_RANGE,
    CONFIG_RESPAWN_DYNAMIC_CREATURE_PERCENT_PER_PLAYER,
    CONFIG_RESPAWN_DYNAMIC_CREATURE_MAX_REDUCTION_RATE,
    CONFIG_RESPAWN_DYNAMIC_GOBJECT_PERCENT_PER_PLAYER,
    CONFIG_RESPAWN_DYNAMIC_GOBJECT_MAX_REDUCTION_RATE,
...
enum WorldIntConfigs : uint32
{
    ...
    CONFIG_INSTANCE_NORMAL_RESET_DELAY,
    ...
    CONFIG_AUCTION_WORKER_THREADS,
    CONFIG_AUCTION_GETALL_DELAY,
    CONFIG_AUCTION_SEARCH_DELAY,
    CONFIG_TALENTS_INSPECTING,
    CONFIG_RESPAWN_DYNAMICMODE,
    CONFIG_RESPAWN_DYNAMIC_CREATURE_PLAYER_THRESHOLD,
    CONFIG_RESPAWN_DYNAMIC_CREATURE_PLAYER_MAX_LEVEL_DIFF,
    CONFIG_RESPAWN_DYNAMIC_CREATURE_MIN_RESPAWN_TIME,
    CONFIG_RESPAWN_DYNAMIC_CREATURE_MIN_RESPAWN_TIME_ELITE,
    CONFIG_RESPAWN_DYNAMIC_CREATURE_MIN_RESPAWN_TIME_INDOOR,
    CONFIG_RESPAWN_DYNAMIC_GOBJECT_PLAYER_THRESHOLD,
    CONFIG_RESPAWN_DYNAMIC_GOBJECT_MIN_RESPAWN_TIME,
